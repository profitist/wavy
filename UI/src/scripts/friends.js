async function getFriends() {
    ...
    try {
        const response = await fetch("http://212.193.27.136/friendships/", {
            headers: {
...
async function LoadPendingFriends() {
    const token = localStorage.getItem('access_token')
        try {
            const response = await fetch("http://212.193.27.136/friendships/pending", {
                method: "GET",
                headers: {
                    "Authorization": `Bearer ${token}`
                }
...
async function AcceptFriend(username) {
    ...
    try {
        const response = await fetch(`http://212.193.27.136/friendships/accept/${username}`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${token}`,
...
async function RejectFriend(username) {
    ...
    try {
        const response = await fetch(`http://212.193.27.136/friendships/reject/${username}`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${token}`,
...
async function FindUser(username) {
    ...
    try {
        const response = await fetch(`http://212.193.27.136/users/${username}`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${token}`,
...
async function SendRequest(username) {
        const token = localStorage.getItem('access_token');
    try {
        const response = await fetch(`http://212.193.27.136/friendships/send/${username}`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${token}`,
