...
Revision ID: 563461c46feb
Revises: 
Create Date: 2025-11-23 22:29:33.215285
...
def upgrade() -> None:
    ...
    sa.Column('platform', sa.Enum('SPOTIFY', 'YANDEX', 'APPLE', 'VK', 'OTHER', name='musicplatform'), nullable=False),
    ...
    sa.Column('status', sa.Enum('PENDING', 'ACCEPTED', 'REJECTED', name='friendship_status_enum'), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['shared_track_id'], ['shared_tracks.id'], ),
